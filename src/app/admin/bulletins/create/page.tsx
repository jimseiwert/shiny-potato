...
export default function Bulletin() {
    return (
        ...
        <div className="flex h-screen">
            <div className="w-1/6 bg-white">foo</div>
            <div className="grow bg-red">
            <button
        type="button"
        className="block h-16 rounded-lg border-2 border-dashed border-gray-300 p-12 text-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
      >
