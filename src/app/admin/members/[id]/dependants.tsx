    ...
    return (
        dependant.editing ? (
            <div key={"dependant_editing_" + dependant.id} className="flex justify-between gap-x-6 py-6">
                <div className="font-medium w-full">
                    ...
                    <input
                        ...
                        className="block w-full rounded-full border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600"
            ...
            <li key={"dependant_" + dependant.id} className="flex justify-between gap-x-6 py-6">
                ...
                <div className="font-medium ">{dependant.email}</div>
                <div className="font-medium">{dependant.personType.name}</div>
...
export default function Dependants({ memberDependants }: { memberDependants: Dependant[] }) {
    ...
    return (
        <div>
            <h2 className="text-base/7 font-semibold">Dependants</h2>
