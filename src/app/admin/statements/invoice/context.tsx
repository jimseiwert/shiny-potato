...
import { DownloadJsonFile, getFontsData, getPlugins, IsJsonString } from "./helper";
...
export const LetterProvider = ({ templates, baseOptions, children }: Props) => {
  ...
  return (
    <LetterContext.Provider value={{ selectedTemplateId, changeTemplate, templates, baseOptions, uploadJson, saveTemplate, deleteTemplate, changeBase, downloadJsonFile }}>
      {children}
      {!template &&
